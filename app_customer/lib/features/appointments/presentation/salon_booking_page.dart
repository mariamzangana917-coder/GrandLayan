...
class _SalonBookingPageState extends ConsumerState<SalonBookingPage> {
  ...
  Future<void> _submitBooking(List<CatalogItem> allItems) async {
    ...
    final int departmentId = departmentIds.isNotEmpty ? departmentIds.first : 1;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'تعذر تحميل خدمات الصالون.',
                      textAlign: TextAlign.center,
                    ),
                    const SizedBox(height: 16),
                    OutlinedButton.icon(
                      onPressed: () {
                        ref.invalidate(catalogItemsProvider(_salonFilter));
                      },
                              ...
                              ? Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'ماكو خدمة بهذا الاسم ضمن خدمات الصالون.',
                                          textAlign: TextAlign.right,
                                          style: TextStyle(
                                            color: theme
                                                .colorScheme
