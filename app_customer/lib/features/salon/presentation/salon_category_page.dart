...
class SalonCategoryPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SalonCategoryPage> createState() => _SalonCategoryPageState();
}

class _SalonCategoryPageState extends ConsumerState<SalonCategoryPage> {
  ...
  void initState() {
    ...
    _filter = CatalogFilter(department: 'salon', categoryId: widget.categoryId);
  }
